...
FOREMAN_BACKEND=node foreman sling trd docs/TRD.md --dry-run # Preview without creating
FOREMAN_BACKEND=node foreman sling trd docs/TRD.md --auto    # Skip confirmation
```
