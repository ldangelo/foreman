...
Foreman CLI / Dispatcher
  ...
  │    Project/global actions in .foreman/actions or ~/.foreman/actions can override phase behavior without rebuild (`foreman actions list|show|install|create`, use --global for global stubs)
