...
### `foreman doctor`
Default Elixir health checks for server/projections/workers. Legacy Node/Postgres maintenance checks (Postgres connectivity, daemon status, br binary, Pi binary, GitHub auth) require `FOREMAN_BACKEND=node`.
