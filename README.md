...
### `foreman pr`
Default Elixir mode shows projection-backed PR candidates from completed runs; PR creation remains owned by the Elixir finalize workflow. Set `FOREMAN_BACKEND=node` for legacy Refinery PR creation.
