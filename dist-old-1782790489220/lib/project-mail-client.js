...
export function resolveProjectDatabaseUrl(projectPath) {
    if (!projectPath) {
...
export async function createProjectMailClient(projectPath) {
...
//# sourceMappingURL=project-mail-client.js.map