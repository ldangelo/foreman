...
export interface VcsBackend {
     ...
     */
    restackBranch(repoPath: string, branchName: string, oldBase: string, newBase: string): Promise<RebaseResult>;
    /**
     ...
     */
    mergeWithStrategy(repoPath: string, sourceBranch: string, targetBranch: string, strategy: MergeStrategy): Promise<MergeResult>;
    /**
