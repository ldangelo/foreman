 ...
 */
export function normalizeBranchLabel(branch) {
    if (!branch)
        return undefined;
...
export function isValidBranchLabel(branch) {
...
export function extractBranchLabel(labels) {
...
export function isDefaultBranch(branch, defaultBranch) {
    ...
    if (normalizedBranch === normalizedDefault)
        return true;
