 ...
 */
import type { Project, Run, NativeTask, EventType, RunProgress } from "./store.js";
export interface IStore {
    ...
    updateRun(runId: string, updates: Partial<Pick<Run, "status" | "worktree_path" | "session_key" | "started_at" | "completed_at">>): Promise<void>;
