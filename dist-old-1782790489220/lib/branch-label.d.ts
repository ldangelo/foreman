 ...
 */
export declare function normalizeBranchLabel(branch: string | undefined): string | undefined;
export declare function isValidBranchLabel(branch: string | undefined): branch is string;
