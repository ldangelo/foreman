 ...
 */
function correctFilePath(filePath, actualCwd, expectedCwd) {
 ...
 */
export function createDirectoryGuardrail(config, logEvent, projectId, runId) {
    ...
    return (toolName, args, currentCwd) => {
 ...
 */
export function wrapToolWithGuardrail(factory, guardrail, getCwd) {
    return ((...factoryArgs) => {
        ...
        const effectiveCwd = result.correctedCwd ?? factoryCwd;
        return factory(effectiveCwd, ...restArgs);
    });
}
/**
 ...
 */
function extractToolName(factory) {
 ...
 */
export function measureGuardrailOverhead(guardrail) {
