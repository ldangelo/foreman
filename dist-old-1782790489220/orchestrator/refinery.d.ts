...
import type { MergeReport, PrReport, CreatedPr } from "./types.js";
...
export declare class Refinery {
    ...
    private readonly runLookup;
    private readonly registeredProjectId?;
    private readonly postgresAdapter?;
    constructor(store: ForemanStore, seeds: IRefineryTaskClient, projectPath: string, vcsBackend?: VcsBackend, opts?: RefineryOptions);
    private lookupRun;
    private lookupRunsByStatus;
    private lookupRunsByStatuses;
    private lookupRunsByBaseBranch;
    ...
    private getSeedContext;
    private getExistingPrUrl;
    private getExistingPrState;
    private finalizeSuccessfulMerge;
    ensurePullRequestForRun(opts: {
        runId: string;
        baseBranch?: string;
        draft?: boolean;
     ...
     */
    private closeNativeTaskPostMerge;
    /**
     ...
     */
    getCompletedRuns(projectId?: string, seedId?: string): Promise<import("../lib/store.js").Run[]>;
    /**
 ...
 */
export declare function preserveBeadChanges(projectPath: string, branchName: string, targetBranch: string, vcsBackend?: Pick<VcsBackend, "applyPatchToIndex" | "commit">): Promise<BeadPreservationResult>;
export {};
