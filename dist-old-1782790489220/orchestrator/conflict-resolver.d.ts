...
export declare class ConflictResolver {
    ...
    private gitTry;
    private gitShow;
    private gitMergeBase;
    private gitDiff;
    private gitCheckoutBranch;
    private gitMergeNoCommit;
    private gitCommitNoEdit;
    private gitAbortMerge;
    private gitCheckoutTheirs;
    private gitStageFile;
    private gitResetHard;
    private gitRemoveFile;
    private gitCommit;
    private gitStageFileForce;
    private gitRemoveFromIndex;
    private gitRebaseContinue;
    private gitAbortRebase;
    private getConflictingFilesFromDisk;
    private getAddedFiles;
    private getUntrackedFilesFromDisk;
    /**
     ...
     */
    runPostMergeTests(resolvedTiers: Map<string, number>, testCommand?: string, noTests?: boolean, beforeRef?: string): Promise<PostMergeTestResult>;
    /**
     ...
     */
    autoResolveRebaseConflicts(_targetBranch: string): Promise<boolean>;
}
