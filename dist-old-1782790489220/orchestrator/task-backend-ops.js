 ...
 */
export function closeSeed(store, seedId, sender) {
    try {
 ...
 */
export function resetSeedToOpen(store, seedId, sender) {
    try {
 ...
 * @param sender - Human-readable source label.
 */
export function markTaskInCooldown(store, seedId, cooldownUntil, sender) {
    try {
 ...
 * @param sender - Human-readable source label.
 */
export function resetCooldownTaskToReady(store, seedId, sender) {
    try {
        store.updateTaskStatus(seedId, "ready");
 ...
 * @param sender - Human-readable source label.
 */
export function markSeedFailed(store, seedId, sender) {
    try {
 ...
 * @param sender - Human-readable source label.
 */
export function updateSeedStatus(store, seedId, status, sender) {
    try {
 ...
 */
export async function syncTaskStatusOnStartup(store, projectId, opts) {
...
export function enqueueAddNotesToBead(_store, _seedId, _note, _sender) {
