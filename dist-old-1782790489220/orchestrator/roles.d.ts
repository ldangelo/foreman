 ...
 */
export declare function parseFinalizeFailureScope(reportContent: string): FinalizeFailureScope;
export declare function parseFinalizeValidationStatus(reportContent: string): FinalizeValidationStatus;
export declare function parseFinalizeIntegrationStatus(reportContent: string): FinalizeIntegrationStatus;
export declare function qaReportHasTestEvidence(reportContent: string): boolean;
