...
export class MergeQueue {
    ...
    enqueue(input) {
        ...
        const row = this.db
            .prepare(`INSERT INTO merge_queue (branch_name, seed_id, run_id, operation, agent_name, files_modified, enqueued_at, status)
         VALUES (?, ?, ?, ?, ?, ?, ?, 'pending')
         RETURNING *`)
            .get(branchName, seedId, runId, operation, agentName ?? null, filesJson, now);
