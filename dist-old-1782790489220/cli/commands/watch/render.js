 ...
 */
export function renderWatch(state) {
 ...
 */
export function renderWatchHeader(state) {
 ...
 */
export function renderWatchFooter(state) {
 ...
 */
export function renderErrorToast(message, width) {
