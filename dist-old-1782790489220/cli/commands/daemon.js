...
import { DaemonManager, DaemonAlreadyRunningError, DaemonNotRunningError, } from "../../lib/daemon-manager.js";
...
function readDaemonLogExcerpt(path) {
    if (!existsSync(path))
        return null;
...
const startCommand = new Command("start")
    ...
    try {
        ...
        if (!mgr.isRunning()) {
            ...
            console.error(chalk.red("Error: daemon exited before startup completed.") +
...
export const daemonCommand = new Command("daemon")
    .description("Manage the ForemanDaemon process lifecycle (start/stop/status/restart)")
