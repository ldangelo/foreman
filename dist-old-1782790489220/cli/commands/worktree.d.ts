 ...
 */
export declare function listForemanWorktrees(projectPath: string, store: Pick<PostgresStore, "getRunsForSeed"> | Pick<ForemanStore, "getRunsForSeed">): Promise<WorktreeInfo[]>;
/**
...
export declare function worktreeListCommandAction(opts: WorktreeListOpts): Promise<void>;
export declare function worktreeCleanCommandAction(opts: WorktreeCleanOpts): Promise<void>;
