 ...
 */
export declare function attachAction(id: string, opts: AttachOpts, store: ForemanStore, projectPath: string, daemon?: DaemonAttachContext | null): Promise<number>;
/**
...
export declare function listSessionsEnhancedDaemon(context: DaemonAttachContext): Promise<void>;
