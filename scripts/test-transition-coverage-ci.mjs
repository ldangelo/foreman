...
const nodeFrontendScope = [
  ...
  "src/lib/report-paths.ts",
  "src/lib/run-status.ts",
  "src/lib/sandbox-providers/index.ts",
  "src/lib/setup.ts",
  "src/lib/task-client-factory.ts",
  "src/lib/vcs/index.ts",
  "src/lib/workflow-loader.ts",
  "src/lib/workspace-paths.ts",
  "src/orchestrator/agent-worker-fatal-path.ts",
  "src/orchestrator/agent-worker-mark-stuck-observability.ts",
  "src/orchestrator/agent-worker-run-status.ts",
  "src/orchestrator/auto-merge.ts",
  "src/orchestrator/dispatcher.ts",
  "src/orchestrator/guardrails.ts",
  "src/orchestrator/heartbeat-manager.ts",
  "src/orchestrator/jira-trigger-event.ts",
  "src/orchestrator/merge-config.ts",
  "src/orchestrator/merge-validator.ts",
  "src/orchestrator/notification-server.ts",
  "src/orchestrator/pi-rpc-spawn-strategy.ts",
  "src/orchestrator/pipeline-executor.ts",
  "src/orchestrator/roles.ts",
  "src/orchestrator/run-lifecycle-service.ts",
  "src/orchestrator/session-log.ts",
  "src/orchestrator/sling-executor.ts",
  "src/orchestrator/sprint-parallel.ts",
  "src/orchestrator/task-phase-status.ts",
  "src/orchestrator/template-loader.ts",
  "src/orchestrator/templates.ts",
...
const summary = {
  ...
  nodeFrontendScope: {
    description: "Node frontend/operator CLI files, supporting frontend libraries, and Node/Pi worker-bridge modules that participate in default Elixir-backed operator workflows, legacy-gating, import/cutover, scheduler dispatch, and task/run/event projections. Legacy Node backend-only daemon/store internals remain outside this transition coverage target.",
