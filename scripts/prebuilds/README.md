...
**Current version:** `better-sqlite3 v12.8.0` — Node ABI v115 (Node 20)

See `version.json` for metadata about the downloaded prebuilts.

## Contents

| Directory       | Platform          | ABI   | Node version | File size |
|-----------------|-------------------|-------|--------------|-----------|
| `darwin-arm64/` | macOS Apple Silicon | v115  | Node 20      | ~1.8 MB   |
| `darwin-x64/`   | macOS Intel         | v115  | Node 20      | ~1.8 MB   |
| `linux-x64/`    | Linux x86_64        | v115  | Node 20      | ~2.0 MB   |
| `linux-arm64/`  | Linux ARM64         | v115  | Node 20      | ~1.9 MB   |
| `win-x64/`      | Windows 64-bit      | v115  | Node 20      | ~1.8 MB   |
