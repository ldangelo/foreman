...
| `m` / `e` / `l` / `r` / `f` | Messages, events, logs, reports, files tabs; messages render oldest-first (newest at bottom) with local `mm/dd hh:mm`, sender, receiver, and message columns |
