...
foreman actions validate                # Validate names, JS syntax, function exports, duplicate variants, and workflow refs
...
| `validate [--json]` | Validate project/global module names, JS syntax, function exports, duplicate `.js`/`.mjs` variants, and unresolved workflow action refs |
