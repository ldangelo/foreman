...
foreman actions validate                # Validate names, JS/TS syntax, function exports, duplicate variants, and workflow refs
...
| `validate [--json]` | Validate project/global module names, JS/TS syntax, function exports, duplicate `.js`/`.mjs`/`.ts` variants, and unresolved workflow action refs |
