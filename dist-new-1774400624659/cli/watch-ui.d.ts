 ...
 */
export declare function renderAgentCard(run: Run, progress: RunProgress | null, isExpanded?: boolean, index?: number, attemptNumber?: number, previousStatus?: string): string;
 ...
 */
export declare function renderWatchDisplay(state: WatchState, showDetachHint?: boolean, expandedRunIds?: Set<string>, notification?: string): string;
