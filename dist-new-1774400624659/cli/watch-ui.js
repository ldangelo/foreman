 ...
 */
export function renderAgentCard(run, progress, isExpanded = true, index, attemptNumber, previousStatus) {
    if (!isExpanded) {
 ...
 */
export function renderWatchDisplay(state, showDetachHint = true, expandedRunIds, notification) {
