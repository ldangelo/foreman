...
export function finalizePrompt(seedId, seedTitle, runId, baseBranch, opts, worktreePath) {
    return resolvePrompt("finalize", { seedId, seedTitle, runId: runId ?? "", agentRole: "finalize", baseBranch: baseBranch ?? "main", worktreePath: worktreePath ?? "" }, "finalize-prompt.md", opts);
}
