 ...
 */
export async function createTaskClients(projectPath) {
...
export const runCommand = new Command("run")
    ...
    const skipExplore = opts.skipExplore;
        ...
        if (!dryRun && project) {
            try {
                ...
                if (syncResult.synced > 0 || syncResult.mismatches.length > 0) {
                    console.log(chalk.dim(`[startup] Reconciled ${syncResult.synced} bead(s), ` +
