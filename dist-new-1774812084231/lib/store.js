 ...
 */
function resolveBundledNativeBinding() {
    try {
...
export class ForemanStore {
    ...
    createRun(projectId, seedId, agentType, worktreePath, opts) {
        ...
        this.db
            .prepare(`INSERT INTO runs (id, project_id, seed_id, agent_type, session_key, worktree_path, status, started_at, completed_at, created_at, base_branch)
     ...
     */
    enqueueBeadWrite(sender, operation, payload) {
        const entry = {
            id: randomUUID(),
            sender,
            operation,
        ...
        this.db
            .prepare(`INSERT INTO bead_write_queue (id, sender, operation, payload, created_at, processed_at)
    ...
    getPendingBeadWrites() {
        return this.db
            .prepare(`SELECT * FROM bead_write_queue
