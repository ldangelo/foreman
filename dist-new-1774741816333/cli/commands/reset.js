...
export const resetCommand = new Command("reset")
    ...
    try {
        ...
        const staleResult = await detectAndHandleStaleBranches(store, seeds, mergeQueue, projectPath, project.id, seedIds, // skip seeds already handled by the main reset loop
        { dryRun });
