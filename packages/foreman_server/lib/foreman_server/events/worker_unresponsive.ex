defmodule ForemanServer.Events.WorkerUnresponsive do
  @moduledoc "Emitted when a worker misses its heartbeat deadline."
  ...
  defstruct [:run_id, :worker_id, :reason, :sequence, :detected_at]
  ...
  def from_payload(payload) do
    %__MODULE__{
      ...
      reason: get(payload, :reason, "heartbeat timeout"),
      sequence: get(payload, :sequence),
      detected_at: get_dt(payload, :detected_at)
    }
  end
