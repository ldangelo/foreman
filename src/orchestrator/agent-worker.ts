...
import { inferPhaseActionType, phaseActionCapabilities } from "./phase-actions.js";
    ...
    await executePipeline({
      ...
      async runBuiltinPhase(phase: WorkflowPhaseConfig, progress?: RunProgress) {
        try {
          ...
          const declaredCapabilities = phaseActionCapabilities(actionType, phase.capabilities);
