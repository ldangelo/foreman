...
- If the blocking finding is already fixed on the target branch and this retry has no task diff to repair, document the evidence in `DEVELOPER_REPORT.md` and leave the working tree clean.
