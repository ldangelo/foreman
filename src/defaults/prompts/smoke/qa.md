...
```
/send-mail --to foreman --subject phase-started --body '{"phase":"qa","smoke":true}'
```
...
```
/send-mail --to foreman --subject phase-complete --body '{"phase":"qa","smoke":true,"status":"complete"}'
```
