...
async function resolveElixirRuns(context: ElixirRecoverContext, beadId: string): Promise<Run[]> {
...
async function collectElixirReport(context: ElixirRecoverContext, runId: string): Promise<Record<string, string>> {
  try {
...
async function findElixirLog(context: ElixirRecoverContext, runId: string): Promise<string | null> {
  try {
