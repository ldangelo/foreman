...
export const runCommand = new Command("run")
  ...
  .addOption(new Option("--skip-explore", "(deprecated) No effect — use --workflow <name> with a custom workflow").hideHelp())
  .addOption(new Option("--skip-review", "(deprecated) No effect — use --workflow <name> with a custom workflow").hideHelp())
