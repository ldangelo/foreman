...
const { mockResolveRepoRootProjectPath, mockFindRegisteredProjectByPath, mockEnsureRunning, mockListRuns, mockElixirClientCtor } = vi.hoisted(() => ({
...
import { renderElixirMergeView } from "../merge.js";
