...
const sendCommand = new Command("send")
    ...
    if (!runId) {
        process.stderr.write("mail send error: --run-id is required (or set FOREMAN_RUN_ID)\n");
        process.exit(1);
    }
    ...
    try {
        ...
        process.stderr.write(`mail send error: --body must be valid JSON (got: ${options.body})\n`);
        process.exit(1);
    }
